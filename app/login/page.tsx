  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-3xl border border-white/10 bg-slate-900/80 p-6 shadow-2xl shadow-violet-900/20 backdrop-blur-xl sm:p-8">
        <p className="mb-2 text-sm uppercase tracking-[0.22em] text-emerald-300/80">Wedding Market</p>
        <h1 className="mb-2 text-3xl font-bold text-white">Eugene & CY Prediction Game</h1>
