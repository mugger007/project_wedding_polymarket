  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-3xl border-2 border-[#d1d5db] bg-white p-6 shadow-[0_12px_34px_rgba(0,0,0,0.14)] sm:p-8">
        ...
        <h1 className="mb-2 text-3xl font-black text-[#0a0a0a]">{config.event_name} Prediction Game</h1>
        <p className="mb-6 text-sm font-semibold text-[#374151]">Start with 1,000 {config.currency_name} Bucks and trade predictions live.</p>
        <LoginForm />
      </div>
    </main>
  );
